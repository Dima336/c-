...
namespace sr1
{
    class Cars
    {
        ...
        public Cars()
        {
            string[] colors11 = { "Black", "Blue" };
            string[] colors22 = { "Red", "Blue" };
            string[] colors33 = { "White", "Yellow" };
            cars.Add(new Car(colors11, 1997, 120000, 15));
            cars.Add(new Car(colors22, 1999, 70000, 20));
            cars.Add(new Car(colors11, 1994, 120000, 25));
            cars.Add(new Car(colors22, 1993, 1000002, 30));
            cars.Add(new Car(colors33, 2002, 1000003, 40));
        }
        ...
        public void findCar(byte amount, string color, int yearOfMade = 0, int price = 0, int enginePower = 0)
        {
            ...
            else
            {
                ...
                Console.WriteLine("\n-Извините, машини с такими параметрами нету ");
            }
        }
